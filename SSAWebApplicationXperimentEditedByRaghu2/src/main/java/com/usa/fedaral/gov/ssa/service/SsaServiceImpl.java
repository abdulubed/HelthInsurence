...
import com.usa.fedaral.gov.ssa.exceptionhandler.RestSsaIdNotFoundException;
...
public class SsaServiceImpl extends Exception implements SsaService {
	...
	public String getStateNameById(Long ssnNumber) {
		...
		if(ssnMasterEntity.isPresent()) {
			...
			throw new RestSsaIdNotFoundException("Citizen SsnNumber not found with SsnNumber" +ssnNumber);
