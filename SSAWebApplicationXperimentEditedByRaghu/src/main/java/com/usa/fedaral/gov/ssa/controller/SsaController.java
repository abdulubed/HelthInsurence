...
public class SsaController {
	...
	public String getStatesList(Model model) {
		 ...
		 * 
		 * List<String> allRecords = new ArrayList(); for(StatesModel statesModel :
		 * statesList) { String stateName = statesModel.getStateName();
		 * allRecords.add(stateName); } model.addAttribute("list", statesList); return
	...
	public String getallSsnRecords(Model model) {
		...
		List ssnRecords = ssaServiceImpl.getAllSsnRecords();
